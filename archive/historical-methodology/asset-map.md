...
- `mechanical_or_review_gate`: 보관된 프로토타입별 verdict 실행 결과를 `archive/training-snapshots/c4-3/cycle-record.md` 또는 `archive/training-snapshots/closed/<id>/cycle-record.md`에 기록. 빈 출력·unknown은 fail.
