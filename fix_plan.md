...
- [ ] **C2 Session 계획** (졸업선: contract.md C2 Convergence 6기준, N=5) — 승인 대기 (approve-6):
  - **c2-1** 결합 구조 후보 — 유형 혼합(R9 첫 실전) + cross-axis 구동사 문항(졸업 기준 1) 첫 도입. 입력: c1 교훈 전부 + 운영 피드백(유형 다양화·정답 셔플)
  - **c2-2~3** 코퍼스 두께 사이클 — 동사 5개·불변화사 2개·문항 100+ (기준 2), 일일 공급 구조(R6), 출처 사람 리뷰 준비(기준 5 = approve-4)
