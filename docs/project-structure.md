...
| `public/legacy/c4-3/` | Static copy of the representative prototype evidence for product continuity during migration. Generated by `npm run prototype:sync`. |
| `assets/` | Content and training design source of truth. Do not treat this as app implementation code. |
| `archive/prototypes/` | Closed prototype evidence archive. Do not patch old prototypes to ship new product behavior. |
...
| `product/` | Human-readable product contract summary and demand validation plan. Archived prototype planning docs live under `archive/product-weaver/`. |
...
1. Keep `archive/prototypes/c4-3/` immutable.
...
- `npm run verdict` checks the representative prototype evidence.
...
- Do not use `archive/prototypes/` as active product source. It is the evidence archive.
