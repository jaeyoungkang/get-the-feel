...
- evidence: code-trace: `app/explain/page.tsx`, `src/content/explanation-index.ts`, `app/explain/sentence-explainer.tsx`; runtime-output: `npm run ui:check`.
...
- evidence: code-trace: `app/explain/page.tsx`; runtime-output: `npm run build`.
- run: `npm run build`
...
- evidence: code-trace: `src/content/explanation-index.ts`, empty state copy in `app/explain/sentence-explainer.tsx`; runtime-output: `npm run typecheck`.
- run: `npm run typecheck`

### acceptance-check:sentence-explanation-practice-link

- description: The active explanation renders practice cards sourced from the same sense's `training_items` and `transfer_items`, excluding an exact source item when possible, preserving visual labels, shuffling displayed choices, and keeping Korean translation inside answer feedback.
- evidence: code-trace: `practiceForSense` in `src/content/explanation-index.ts`, `app/explain/sentence-explainer.tsx`; runtime-output: `npm run ui:check`.
