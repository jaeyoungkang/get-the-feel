...
Append-only judgment ledger for Story Chain decisions that cannot be reduced to a deterministic check.

## 2026-06-14 - initial Story Chain backfill
...
- evidence: `product/contract.md`, `docs/contracts/story-chain/evidence-ledgers/current-build.ledger.md`
