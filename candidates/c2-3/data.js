/* get-the-feel · c2-3 — data.js
 * window.CONTENT_ALL = assets/content 8파일 verbatim 임베드 (의존성 0, file:// 안전).
 * 출제 풀 = 8파일 전부. 이 파일은 콘텐츠를 손으로 고치지 않는다 — 정본은 assets/content/*.json.
 * data-sync 검사가 각 키를 원본 json과 의미 비교한다 (verbatim 보증).
 */
window.CONTENT_ALL = {
  "have": {
    "axis": "core-verbs",
    ...
    "senses": [
      {
        ...
        "source_refs": [
          {
            "source_id": "talmy-2000",
            "locator": "Vol. I, Ch. on force dynamics — maintenance of a state against a tendency toward change (the 'keeping' force pattern)",
            "claim": "힘 역학(force dynamics)에서 어떤 상태·위치를 '유지'하는 것은 그것이 변하거나 벗어나려는 내재적 경향(tendency)에 대항하는 대항력의 작용으로 분석되며, 단순한 정적 존재와 구별된다."
          },
          {
            "source_id": "langacker-1987",
            "locator": "Vol. I, Ch. on stative/maintained relations — continued control of a relation over time",
            "claim": "동사는 어떤 관계가 시간에 걸쳐 유지·통제되는 과정을 윤곽 지을 수 있으며, 이는 두 개체 사이의 정적 관계만 윤곽 짓는 소유 동사와 달리 관계의 지속적 유지를 핵심으로 삼는다."
          }
        ],
        "validation": {
          "method": "subagent-consensus",
      ...
      },
      {
        ...
        "source_refs": [
          {
            "source_id": "talmy-2000",
            "locator": "Vol. I, Ch. on force dynamics — causative/maintenance of a resultant state against decay",
          ...
          {
            "source_id": "langacker-1987",
            "locator": "Vol. II, Ch. on resultative / maintained-state predications — keep + complement",
            "claim": "keep + 형용사·분사 보어 구문은 주어가 대상을 어떤 상태에 계속 머물게 하는 유지 관계를 윤곽 지으며, 상태로의 변화를 윤곽 짓는 inchoative(get류)와 구별된다."
          }
        ],
        "validation": {
          "method": "subagent-consensus",
