...
9. **한국어 해석 (`sentence_ko`)**: c2-3부터 전 문항 필수 — 영어 문장의 자연스러운 한국어 해석 한 줄. **앱은 정답 후 피드백에만 표시** (정답 전 노출은 verb-choice 답 누설 + 번역 우회 — UX 문법 G12). 해석문이 보기 단어를 직역으로 포함해 답을 누설하지 않는지 검수 대상.
