...
> 현재 기준선: 배포 URL https://jaeyoung2026.github.io/get-the-feel/ , 11파일 24 sense 173문항.
...
| `최소_artifact` | 배포된 현재 제품 (11파일 24 sense 173문항, 핵심 동사 8·불변화사 2·구동사 1, 인식+산출 모드, 감각별 통계, 해석 피드백, 로컬 기록) + blind task 안내문 4질문 |
...
- `as_of`: 콘텐츠는 현재 배포 제품(11파일 24 sense 173문항) 기준. 갱신 시 버전 표기.
...
- `correction`: 콘텐츠 오류 발견 시 코퍼스 수정 → content-consensus 재검수 → 재배포.
