...
- Session **C1 = Discovery**. 후보 상한 `n_of_N` **N=3** (approve-1 승인), 도달 실패 시 `cap_reached_disposition` 분류 후 종료 (`product/contract.md` 상한 섹션).
...
- 콘텐츠 신규·변경: `skills/content-consensus/SKILL.md` 경유 (3자 합의 + receipt — verdict가 기록 존재를 기계 확인).
