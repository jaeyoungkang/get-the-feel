...
function buildPublicSignal() {
  ...
  return {
    ...
    product_surface: "paid_proof_ready_local_candidate",
    ...
    evidence_status: "paid_proof_packet_local_export",
...
feedbackForm.addEventListener("submit", (event) => {
  ...
  localStorage.setItem("ai-bottleneck-r10-paid-proof-context", JSON.stringify(signal));
...
downloadSignalButton.addEventListener("click", () => {
  ...
  link.href = url;
  link.download = "ai-bottleneck-r10-paid-proof-intent.json";
  link.click();
