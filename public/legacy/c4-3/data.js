    ...
    "senses": [
      ...
      },
      {
        ...
        "validation": {
          ...
          "strength": "weak",
          "date": "2026-06-13",
          "basis": "content-consensus 3자 합의(생성·적대적 검수·수정). inchoative 핵심 주장은 get-state-change와 동일 T1(langacker-1987·lakoff-1993) 계열 — 과거분사로의 확장. mediopassive/재귀 기원 라벨은 미확인 표기(원전 직접 귀속 아님). strong 승격은 사람 리뷰 대기."
        }
      }
    ],
    "training_items": [
  ...
  "be": {
    ...
    "senses": [
      ...
      },
      {
        ...
        "boundary_ko": "be tired는 피곤한 상태에 '머물러 있음'(I am tired = 지금 피곤한 자리에 있음), get tired는 그 상태로 '옮겨 가 닿음'(I get tired = 피곤한 자리로 이동하는 진입 사건). be married는 부부인 상태에 머묾, get married는 그 상태로 막 진입함(get-into-state와 연결). 시점 부사가 붙어 '~한 순간/그때'를 가리키면 머묾이 아니라 진입이라 get 쪽이다.",
        "source_refs": [
          {
            "source_id": "langacker-1987",
    ...
    "senses": [
      ...
      },
      {
        ...
        "validation": {
          ...
          "strength": "weak",
          "date": "2026-06-13",
          "basis": "inchoative 변화 도식은 get-state-change와 동일 T1(lakoff-1993 사건 구조 은유) 계열 — go의 '멀어져 다른 상태로' 방향이 부정·일탈 색을 더한다. 'go=부정 전용' 절대화는 미확인(경향 표기). strong 승격은 사람 리뷰 대기."
        }
      }
    ],
    "training_items": [
    ...
    "senses": [
      ...
      },
      {
        ...
        "validation": {
          ...
          "strength": "weak",
          "date": "2026-06-13",
          "basis": "출현·생겨남을 '드러나는 쪽으로의 이동'으로 보는 도식은 lakoff-1993 사건/은유 계열 + oald 용법. 개별 관용의 관용성·단일 도식 통합은 미확인(교육용 묶음 표기). strong 승격은 사람 리뷰 대기."
        }
      }
    ],
    "training_items": [
